...
def main():
    print("--- FINAL EVALUATION: True Zero-Day Domain Shift Test (Random Forest) ---")
    ...
    # Apply RFE Pruning (using the exact same XGBoost selector for fairness)
    ...
    print("\nTraining Random Forest Model on 2021 Data...")
    ...
    print("\n--- FINAL ZERO-DAY RESULTS (RANDOM FOREST) ---")
