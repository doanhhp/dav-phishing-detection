...
\caption{Probabilistic DOM Tree Structure for Benign Domains (Depth 5). Note the dense hierarchy featuring a rich variety of HTML5 semantic tags.}
...
\caption{Probabilistic DOM Tree Structure for Phishing Domains (Depth 5). Note the lack of semantic tags, relying on sparse \texttt{div} chains and basic form elements.}
